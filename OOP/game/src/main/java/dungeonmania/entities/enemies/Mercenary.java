...
public class Mercenary extends Enemy implements Interactable {
    ...
    /**
     * Check whether the current merc is in bribe radius*
     * @param player
     * @return
     */
    private boolean inBribeRange(Player player) {
        return (Math.abs(player.getPositionX() - this.getPositionX()) <= bribeRadius
                && Math.abs(player.getPositionY() - this.getPositionY()) <= bribeRadius);
    }
    ...
    public void interact(Player player, Game game) {
        if (player.hasSceptre()) {
            ...
            allied = true;
            mindControlDuration = player.getSceptreMindControlDuration() - 1;
    ...
    public void move(Game game) {
        ...
        if (allied || isMindControlled) {
            ...
            if (isMindControlled) {
                ...
                // Mercenary becomes enemy again when mind control ends
