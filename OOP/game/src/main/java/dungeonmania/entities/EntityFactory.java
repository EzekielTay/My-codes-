...
public class EntityFactory {
    ...
    public Snake buildSnake(Position pos) {
        double snakeHealth = config.optDouble("snake_health", Snake.DEFAULT_HEALTH);
        double snakeAttack = config.optDouble("snake_attack", Snake.DEFAULT_ATTACK);
        return new Snake(pos, snakeHealth, snakeAttack, false, false);
    }
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        switch (jsonEntity.getString("type")) {
            ...
            case "bomb":
                ...
                String bombLogic = jsonEntity.optString("logic", Bomb.DEFAULT_LOGIC);
                return new Bomb(pos, bombRadius, bombLogic);
            case "light_bulb_off":
                String bulbLogic = jsonEntity.optString("logic", Bomb.DEFAULT_LOGIC);
                return new LightBulb(pos, bulbLogic);
            case "switch_door":
                String doorLogic = jsonEntity.optString("logic", Bomb.DEFAULT_LOGIC);
