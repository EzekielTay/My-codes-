...
public class BuildablesTest {
    ...
    @Test
    @Tag("5-7")
    @DisplayName("Test insufficient materials to Build sceptre")
    public void failBuildSceptre() {
    ...
    @Test
    @Tag("5-8")
    @DisplayName("Fail to Build midnight armour due to zombies on map")
    public void failbuildMidnightArmour() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_buildEntityFailMidnightArmour", "c_extraBuildablesTest");
