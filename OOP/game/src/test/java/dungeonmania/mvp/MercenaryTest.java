...
public class MercenaryTest {
    ...
    public void outsidebribeRadius() {
        // Wall Wall Wall Wall Wall
    ...
    @Tag("12-6")
    @DisplayName("Testing a mercenary can be bribed within a radius")
    public void withinbribeRadius() {
        // Wall Wall Wall Wall Wall
        // P1 P2/Treasure P3 P4 M4 M3 M2 M1 Wall
        // Wall Wall Wall Wall Wall
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_bribeRadiusinRange", "c_mercenaryTest_bribeRadius");
        String mercId = TestUtils.getEntitiesStream(res, "mercenary").findFirst().get().getId();
